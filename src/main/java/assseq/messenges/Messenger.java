...
public class Messenger {
	...
	public static final Message NOT_IMPLEMENTED = new Message("Function not implemented yet, will hopefully be available in version 0.5", "Function stub only");
