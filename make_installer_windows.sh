...
wine "$INNO_SETUP_PROGRAM" "innosetupfil_for_Assseq_win.iss"

# move static files
rsync -av assseq-windows/* target/windows-latest/
...
mv target/windows-latest/Assseq.exe target/windows-latest/without_installer_version
mv target/windows-latest/assseq.jar target/windows-latest/without_installer_version
